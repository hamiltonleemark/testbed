...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TestProductKeySet',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('testkey', models.ForeignKey(to='testdb.TestKey')),
                ('testproduct', models.ForeignKey(to='testdb.TestProduct')),
            ],
        ),
        migrations.CreateModel(
            name='TestResult',
        ...
        migrations.AddField(
            ...
            name='keys',
            field=models.ManyToManyField(to='testdb.TestKey', through='testdb.TestProductKeySet'),
        ),
        migrations.AddField(
            model_name='testproduct',
            name='product',
        ...
        migrations.AddField(
            model_name='testplan',
            name='keys',
            field=models.ManyToManyField(to='testdb.TestKey', through='testdb.TestplanKeySet'),
        ),
        migrations.AddField(
            model_name='testfile',
            name='key',
